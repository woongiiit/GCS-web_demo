...
export default function LifePage() {
  const products = [
    ...
    },
    {
      ...
      description: '게이밍에 최적화된 마우스패드입니다. 정밀한 움직임과 편안한 사용감을 제공합니다.',
      features: ['대형 사이즈', '고급 천 소재', '미끄럼 방지'],
      inStock: true,
      tags: ['NEW']
    },
    {
      ...
      description: 'GCS 로고가 새겨진 키링입니다. 내구성이 뛰어난 금속 소재로 제작되었습니다.',
      features: ['금속 소재', '내구성 우수', '다양한 디자인'],
      inStock: true,
      tags: ['인기상품']
    },
    {
      ...
      discount: '33%',
      image: '/images/shop/life/cupholder.jpg',
      description: '차량용 컵 홀더입니다. 안정적인 고정과 세련된 디자인이 특징입니다.',
      features: ['차량용', '안정적 고정', '다양한 컵 사이즈'],
      inStock: false,
      tags: ['품절임박']
    },
    {
      ...
      discount: '33%',
      image: '/images/shop/life/stickers.jpg',
      description: '다양한 GCS 디자인의 스티커 세트입니다. 노트북이나 다이어리에 활용하세요.',
      features: ['30장 세트', '다양한 디자인', '고품질 인쇄'],
      inStock: true,
      tags: ['NEW']
    }
  ]
      ...
      <div className="relative min-h-screen bg-white px-4 py-6 sm:px-0">
        <div className="max-w-6xl mx-auto pt-32">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-black mb-4">Life</h1>
            <p className="text-gray-600 mb-8">생활용품과 유틸리티 아이템</p>
