...
export default function ApparelPage() {
  ...
  const products = [
    ...
    },
    {
      ...
      description: '클래식한 폴로셔츠 디자인입니다. 깔끔한 코튼 소재로 제작되었습니다.',
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['화이트', '블랙', '네이비', '레드'],
      inStock: true,
      tags: ['NEW']
    },
    {
      ...
      discount: '21%',
      image: '/images/shop/apparel/short-tshirt.jpg',
      description: '여름에 착용하기 좋은 반팔 티셔츠입니다. 가볍고 시원한 소재로 제작되었습니다.',
      sizes: ['S', 'M', 'L', 'XL'],
      ...
      <div className="relative min-h-screen bg-white px-4 py-6 sm:px-0">
        <div className="max-w-6xl mx-auto pt-32">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-black mb-4">Apparel</h1>
            <p className="text-gray-600 mb-8">GCS 브랜드 의류 컬렉션</p>
